...
const corsOptions = {
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'x-auth-token', 'X-Auth-Token', 'x-host-token', 'X-Host-Token', 'X-Requested-With', 'Accept', 'Origin'],
  credentials: true,
...
app.use('/api/admin', require('./routes/enhancedAdminRoutes'));
